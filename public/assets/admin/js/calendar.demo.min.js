...
*/var handleCalendarDemo=function(){
    ...
    var t=new Date;var n=t.getMonth();
    var r=t.getFullYear();
    ...
    if($("#drop-remove").is(":checked")){
        $(this).remove()}},select:function(e,t,n){
            var r=prompt("Event Title:");
            if(r){i.fullCalendar("renderEvent",{title:r,start:e,end:t,allDay:n},true)}i.fullCalendar("unselect")},
        eventRender:function(e,t,n){var r=e.media?e.media:"";var i=e.description?e.description:"";t.find(".fc-event-title").after($('<span class="fc-event-icons"></span>').html(r));t.find(".fc-event-title").append("<small>"+i+"</small>")},
        editable:true,
        events:[
            {
                title:"Event",
