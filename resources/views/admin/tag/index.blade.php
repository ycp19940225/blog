...
@section('page.content')
    ...
    <h1 class="page-header">{{ $title }}
        <small>
            <button class="btn btn-primary m-l-20" type="button" onclick=" window.location.href='/admin/tag/add' ">添加标签</button>
        </small>
    </h1>
    <div class="row">
        @if (session('status'))
                    ...
                    <div class="table-responsive">
                        <table id="data-table" class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $v['updated_at'] }}</td>
                                <td>
                                    <a class="btn btn-success btn-xs m-2 detail" href="{{ url('admin/tag/edit',['id'=>$v['id']]) }}" >编辑</a>
