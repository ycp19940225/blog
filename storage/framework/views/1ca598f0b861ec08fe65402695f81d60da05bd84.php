                    ...
                    <div class="table-responsive">
                        <table id="data-table" class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('pri-index',['role_id'=>$v['id']])); ?>"  class="btn btn-info btn-xs m-2 delete" >权限</a>
                                    <a class="btn btn-success btn-xs m-2 detail" href="<?php echo e(url('admin/role/edit',['id'=>$v['id']])); ?>" >编辑</a>
            ...
            layer.confirm('是否删除？', {
                ...
                $.post("<?php echo e(url('admin/role/delete')); ?>",data,function (res) {
                    ...
                    if(res['code'] === 'success'){
                        ...
                        setTimeout('location.href="<?php echo e(url('admin/role/index')); ?>"',1000);
                    }else{
